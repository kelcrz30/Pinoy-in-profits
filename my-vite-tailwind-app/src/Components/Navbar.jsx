    ...
    <header className="fixed top-0 w-full bg-white/95 backdrop-blur-sm z-50 border-b border-gray-100 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <img
            src="/Pinoy-in-profits/newlog.png"
            alt=""
...
<Link to="/services#consultation" className="hidden md:block">
  <button className="bg-blue-950 hover:bg-blue-950/95 text-white px-6 py-3 rounded-full font-thin transition-colors">
    Join now
  </button>
</Link>
